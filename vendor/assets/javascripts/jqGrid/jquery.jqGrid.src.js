                    ...
                    $(ts.rows).each(function(i) {
                        if ( i>0 ) {
                            if(!$(this).hasClass("subgrid") && !$(this).hasClass("jqgroup") && !$(this).hasClass('ui-state-disabled')){
                                $("#jqg_"+$.jgrid.jqID(ts.p.id)+"_"+$.jgrid.jqID(this.id) ).prop("checked",true);
                    ...
                    $(ts.rows).each(function(i) {
                        if(i>0) {
                            if(!$(this).hasClass("subgrid") && !$(this).hasClass('ui-state-disabled')){
                                $("#jqg_"+$.jgrid.jqID(ts.p.id)+"_"+$.jgrid.jqID(this.id) ).prop("checked", false);
            ...
            if(cSel === true) {
                if(ts.p.cellEdit === true) {
                    ...
                    if(e[ts.p.multikey]) {
                        ...
                        scb = $("[id^=jqg_"+$.jgrid.jqID(ts.p.id)+"_"+"]").prop("checked");
                        $("[id^=jqg_"+$.jgrid.jqID(ts.p.id)+"_"+"]").prop("checked",!scb);
                    }
                }
